...
servidores <- df_pivot_Exe_serv %>%
  ...
  e_line(Executivo, symbol = "none", legend = FALSE) %>%
  e_line(Legislativo, symbol = "none", legend = FALSE) %>%
  e_line(Judiciário, symbol = "none", legend = FALSE) %>%
  e_line(`Ministério Público`, symbol = "none", legend = FALSE) %>%
  e_datazoom(show = TRUE, toolbox = FALSE) %>%
